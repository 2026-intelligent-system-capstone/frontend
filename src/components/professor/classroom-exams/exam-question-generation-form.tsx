...
interface ExamQuestionGenerationFormProps {
	classroomId: string;
	examId: string;
...
export function ExamQuestionGenerationForm({
	classroomId,
	examId,
	materials,
	formId,
	...
	onCancel,
	onSuccess,
}: ExamQuestionGenerationFormProps) {
	...
	return (
		<form className="space-y-5" id={formId} onSubmit={handleSubmit}>
			{hideHeader ? null : (
				<div>
					<h3 className="text-base font-semibold text-slate-900">AI 문항 생성</h3>
