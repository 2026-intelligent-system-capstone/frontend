...
import { StudentInviteModal } from '@/components/professor/classroom-students/student-invite-modal';
import { StudentsTable } from '@/components/professor/classroom-students/students-table';
