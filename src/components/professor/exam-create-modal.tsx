...
import {
	...
	examTypeOptions,
	toUtcIsoString,
} from '@/lib/classrooms/exam-create';
import { useCreateExam } from '@/lib/hooks/use-classrooms';

import { ExamCreateScheduleField } from '@/components/professor/exam-create/exam-create-schedule-field';
...
export function ExamCreateModal({ classroomId, week }: ExamCreateModalProps) {
	const titleId = useId();
