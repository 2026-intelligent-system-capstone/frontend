import { ApiClientError, type ApiErrorResponse, type BaseResponse } from '@/types/api';
...
const toRequestBody = (body: RequestOptions['body']): BodyInit | undefined => {
	...
	if (isFormData(body) || typeof body === 'string' || body instanceof URLSearchParams || body instanceof Blob || body instanceof ArrayBuffer) {
		return body;
	}
