			...
			{questions.map((question) => {
				...
				return (
					<button
						...
						className={cn(
							`focus-visible:ring-brand-border flex min-w-16 flex-col items-center gap-1 rounded-2xl
							border px-3 py-2.5 text-xs transition-[border-color,background-color,color,box-shadow]
							focus-visible:ring-2 focus-visible:outline-none md:min-w-0 md:px-2`,
							isCurrent
								...
								: isAnswered
									...
									: `border-border-subtle bg-surface-muted text-neutral-gray-500 hover:bg-surface
